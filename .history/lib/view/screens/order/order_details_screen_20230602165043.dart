    ...
    return Scaffold(
      ...
      body: Padding(
        ...
        child: GetBuilder<OrderController>(builder: (orderController) {
          ...
          //   _showBottomView = controllerOrderModel.orderStatus == 'accepted' ||
                  ...
                  if (controllerOrderModel.orderStatus != 'delivered')
                    SliderButton(
                      action: () {
                        ...
                        //           orderController
                        //               .updateOrderStatus(
                        //                   controllerOrderModel.id, 'confirmed',
                        //                   back: true)
                        //               .then((success) {
                        //             if (success) {
                        //               Get.find<AuthController>().getProfile();
                        ...
                        //       ),
                        //       barrierDismissible: false);
                        // } else if (controllerOrderModel.orderStatus ==
                        //     'picked_up') {
                        if (Get.find<SplashController>()
                                .configModel
                                .orderDeliveryVerification ||
                          ...
                          Get.find<OrderController>()
                              .updateOrderStatus(
                                  controllerOrderModel.id, 'delivered')
                              .then((success) {
                            if (success) {
                              Get.find<AuthController>().getProfile();
                              Get.find<OrderController>().getCurrentOrders();
                        ...
                        // } else if (controllerOrderModel.orderStatus ==
                        //     'handover') {
                        //   if (Get.find<AuthController>().profileModel.active ==
                        //       1) {
                        //     Get.find<OrderController>()
                        //         .updateOrderStatus(
                        //             controllerOrderModel.id, 'picked_up')
                        //         .then((success) {
                        //       if (success) {
                        //         Get.find<AuthController>().getProfile();
                        //         Get.find<OrderController>().getCurrentOrders();
