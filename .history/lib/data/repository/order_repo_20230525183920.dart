...
class OrderRepo extends GetxService {
  ...
  Future<Response> getSearchOrder(String orderId) {
    return apiClient.getData('${AppConstants.SEARCH_ORDER}$orderId');
  }

  Future<Response> getCancelReasons() async {
    return await apiClient.getData(
        '${AppConstants.ORDER_CANCELLATION_URI}?offset=1&limit=30&type=deliveryman');
  }
}
