...
class AppConstants {
  static const String APP_NAME = 'Belitzo Fahrer';
  static const double APP_VERSION = 6.2;

  // testing
  // static const String BASE_URL = 'https://belitzo.de/individual/merchant';
  //production
  static const String BASE_URL = 'https://restaurant.belitzo.de';
  ...
  static const String SEARCH_ORDER =
      '/api/v1/delivery-man/search-orders?search_text=';
  ...
  static const String SHIFT_URI = '/api/v1/delivery-man/dm-shift?token=';
