...
class OrderProductWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    orderDetails.addOns.forEach((addOn) {
      _addOnText =
          _addOnText + '${(_addOnText.isEmpty) ? '' : ',  '}${addOn.name}';
      _addOnPrice = _addOnPrice + addOn.price;
    });
    ...
    if (orderDetails.oldVariation != null &&
        orderDetails.oldVariation.length > 0) {
      _variationText = orderDetails.oldVariation[0].type;
    }

    var code = "";
    if (orderDetails.foodDetails.code != null &&
        orderDetails.foodDetails.code.isNotEmpty) {
      code = orderDetails.foodDetails.code + " ";
    }
            ...
            Row(children: [
              ...
              Text(
                PriceConverter.convertPrice(
                    (orderDetails.price + _addOnPrice) * orderDetails.quantity),
                style: robotoMedium.copyWith(
