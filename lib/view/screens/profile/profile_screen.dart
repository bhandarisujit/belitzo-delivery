          ...
          mainWidget: SingleChildScrollView(physics: BouncingScrollPhysics(), child: Center(child: Container(
            ...
            child: Column(children: [
              ...
              authController.profileModel.shiftName != null ? RichText(text: TextSpan(children: [
                TextSpan(text: 'shift'.tr + ': ', style: robotoMedium.copyWith(color: Theme.of(context).textTheme.bodyLarge.color, fontSize: Dimensions.FONT_SIZE_SMALL)),
                TextSpan(text: ' ${authController.profileModel.shiftName}', style: robotoMedium.copyWith(color: Theme.of(context).primaryColor, fontSize: Dimensions.FONT_SIZE_SMALL)),
