    ...
    return Scaffold(
      ...
      body: GetBuilder<AuthController>(
        builder: (authController) {
          authController.profileModel.incentiveList.forEach((incentive) {
              ...
              children: [
                Container(
                  ...
                  decoration: BoxDecoration(
                    color: Theme.of(context).primaryColor, borderRadius: BorderRadius.circular(Dimensions.RADIUS_DEFAULT),
                  ),
                  child: Center(child: Text(
                    'you_have_total_incentive'.tr + '\n' + PriceConverter.convertPrice(authController.profileModel.totalIncentiveEarning),
                    textAlign: TextAlign.center, style: robotoBold.copyWith(fontSize: Dimensions.FONT_SIZE_OVER_LARGE, color: Theme.of(context).cardColor),
                  )),
                ),
                ...
                authController.profileModel.incentiveList.isNotEmpty ? ListView.builder(
                  ...
                  return Padding(
                    ...
                    child: Container(
                      decoration: BoxDecoration(
                        color: Theme.of(context).cardColor, borderRadius: BorderRadius.circular(Dimensions.RADIUS_DEFAULT),
